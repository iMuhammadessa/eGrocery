        ...
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.png" max-height="100%" max-width="100%" contain>
              ...
              <h2 class="title1">Order yours</h2>
            </v-card-title>
            ...
            <v-card-text class="ml-10">
              <v-row>
                <v-col cols="4">
                  <v-text-field label="Search your daily groceries" class="d-none d-sm-none d-md-flex" filled solo prepend-inner-icon="mdi-magnify" flat rounded outlined success>
                  </v-text-field>
                </v-col>
          ...
          <v-card flat color="#E2F2E5" class="rounded-xl mtop mbottom mx-10 pa-4" height="350">
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                ...
                <p>
                  Download app from Play store or Apple store <br>
                  to enjoy our best services all over Pakistan. <br>
                  We deals with all types of grocery, food, packs & more. <br><br>
...
import AppPack from '../components/AppPack.vue'
