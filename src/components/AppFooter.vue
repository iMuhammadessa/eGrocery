    ...
    <v-card flat tile class="black white--text py-12 px-5" width="100%">
      <v-row>
        ...
        <v-col cols="12" xs="12" sm="6" md="2">
          ...
          <v-card-text class="grey--text mt-n4"> Our Services </v-card-text>
        ...
        <v-col cols="12" xs="12" sm="6" md="4">
          ...
          <v-card-text class="grey--text"> Muhammad Essa </v-card-text>
          <v-card-text class="grey--text mt-n4">
            Hangu, Pakistan
          </v-card-text>
          <v-card-text class="grey--text mt-n4"> www.muhammadessa.com </v-card-text>
          <v-card-text class="grey--text mt-n4"> +92 332 9257074 </v-card-text>
        </v-col>
      </v-row>
    </v-card>
  </v-footer>
